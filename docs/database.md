...
| created_at | TIMESTAMP | NOT NULL, DEFAULT timezone('Asia/Shanghai', now()) | 创建时间 |
| updated_at | TIMESTAMP | NOT NULL, DEFAULT timezone('Asia/Shanghai', now()) | 最后修改时间 |
...
| is_active | BOOLEAN | NOT NULL, DEFAULT true | 是否有效（软删除） |
| created_at | TIMESTAMP | NOT NULL, DEFAULT timezone('Asia/Shanghai', now()) | 创建时间 |
| updated_at | TIMESTAMP | NOT NULL, DEFAULT timezone('Asia/Shanghai', now()) | 更新时间 |
...
| created_at | TIMESTAMP | NOT NULL, DEFAULT timezone('Asia/Shanghai', now()) | 事件创建时间 |
